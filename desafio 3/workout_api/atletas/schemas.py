...
from models import CategoriaIn
from schemas import CentroTreinamentoAtleta, BaseSchema, OutMixin


class Atleta(BaseSchema):
    nome: Annotated[str, Field(
        description='Nome do atleta', example='Joao Da Silva', max_length=50)]
    ...
    peso: Annotated[PositiveFloat, Field(
        description='Peso do atleta', example=75.5)]
    altura: Annotated[PositiveFloat, Field(
        description='Altura do atleta', example=1.70)]
...
class AtletaUpdate(BaseSchema):
    ...
    idade: Annotated[Optional[int], Field(
        None, description='Idade do atleta', example=25)]
